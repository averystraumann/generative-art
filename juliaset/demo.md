here are some examples of drawings made with these source files! to make your own, download the source files and the processing software, and change the two float arguments in the
